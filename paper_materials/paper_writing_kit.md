...
单轮胜率，并将重复率从早期实验的 40.2% 降至 18.1%，但单轮配对差异的 95%
置信区间仍包含零。四个 LoRA 模型的多轮综合分均低于带角色卡基线。结果表明，
...
| Table 1 | 四个训练配置 | `training_and_evaluation_design.md` |
| Table 2 | 训练效率与硬件 | `training_comparison.csv` |
| Table 3 | 四轮核心 LoRA 指标 | `experiment_comparison.csv` |
